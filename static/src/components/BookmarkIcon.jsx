...
export const HERO_ICONS = {
  ...
  robot: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 1-6.23.693L5 15.3m14.8 0 .002 1.194c.003.436-.18.854-.508 1.142l-6.217 5.46a.75.75 0 0 1-.99 0L5.87 17.636a1.5 1.5 0 0 1-.508-1.142L5.2 15.3" />
    </svg>
  ),
  brain: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function BookmarkIcon({ bookmark, categoryColor, categoryDefaultSymbol }) {
  ...
  if (categoryDefaultSymbol) {
    const categoryIcon = HERO_ICONS[categoryDefaultSymbol.toLowerCase()];
    if (categoryIcon) {
      return (
        <div className="bookmark-icon" style={gradientStyle}>
          {categoryIcon}
